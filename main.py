...
MODEL_LIST = [
    ...
    'gemini-2.0-flash',       # Спроба 2: Стабільна швидка
    'gemini-2.0-flash-lite',  # Спроба 3: Економна
    'gemini-2.0-flash-001',       # Спроба 4: Стандартна
    'gemini-1.5-pro'          # Спроба 5: Повільна, але якісна (резерв)
]
